 ...
 *
 * The sharpest pinhole for a 100 mm box is 0.36 mm out of a 0.05–5 mm range.
 * On a linear track that sweet spot sits at 6 % of the width and a child sweeps
 * straight past it; on this one it lands near the middle. Every scale in the
 * app where the interesting value is orders of magnitude from the ends should
 * use it.
 */
